...
module.exports = async function backend() {
  console.log("");
  console.log(chalk.yellowBright(figlet.textSync("BACKEND", { font: "Small" })));
  console.log("");
  ...
  switch (buildTools) {
    case "Node.js":
      ...
      spawn("npm", ["init", "-y"], { stdio: "inherit", cwd: projectPath, shell: true });
      break;
    case "Express.js":
      spawn("npx", ["express-generator", projectName], { stdio: "inherit", shell: true });
      break;
    case "Nest.js":
      spawn("npx", ["@nestjs/cli", "new", projectName], { stdio: "inherit", shell: true });
      break;
    case "Nuxt.js":
      spawn("npx", ["nuxi@latest", "init", projectName], { stdio: "inherit", shell: true });
      break;
    case "Fastify":
      spawn("npx", ["fastify-cli", "generate", projectName], { stdio: "inherit", shell: true });
      break;
    case "Golang":
      if (!fs.existsSync(projectPath)) fs.mkdirSync(projectPath, { recursive: true });
      spawn("go", ["mod", "init", projectName], { stdio: "inherit", cwd: projectPath, shell: true });
      break;
    case "Django":
      spawn("django-admin", ["startproject", projectName], { stdio: "inherit", shell: true });
      break;
    case "Flask":
      if (!fs.existsSync(projectPath)) fs.mkdirSync(projectPath, { recursive: true });
    ...
    case "FastAPI":
      ...
      break;
    case "Laravel":
      spawn("composer", ["create-project", "laravel/laravel", projectName], { stdio: "inherit", shell: true });
      break;
  }
